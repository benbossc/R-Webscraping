...
Q8: From the same <a href="https://www.iihs.org/topics/fatality-statistics/detail/state-by-state">IIHS website</a> from Q1, import data related to seat belt usage. Join the dataframe you created in Q1 wiht seat belt use and make a scatter plot of percent seat belt use vs. number of fatalities per 100,000 persons. (Note: Consider joining by State)
